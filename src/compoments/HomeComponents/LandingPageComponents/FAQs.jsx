        ...
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              injected humour, or randomised words which don't look even.take
              the dummy data.
            </p>
          </div>
            ...
            >
              ...
              >
                ...
                <div className="flex items-center gap-4 ">
                  ...
                  <span
                    className={` font-bold  text-black-600 transition-transform duration-300 ${
                      openIndex === index ? " text-indigo-600" : ""
                    }`}
                  >
                    {faq.question}
                  </span>
