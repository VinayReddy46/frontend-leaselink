...
const Footer = () => {
  return (
    ...
    <footer className="h-screen bg-blue-100/80 font-sans dark:bg-gray-900">
    <div className="container px-6 py-12 mx-auto">
        ...
        <p className="font-sans p-8 text-gray-800 dark:text-gray-300 text-start md:text-center md:text-lg md:p-4">© 2025 LeaseLink. All rights reserved.</p>
    </div>
</footer>
