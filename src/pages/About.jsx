  ...
  return (
    <div className="bg-gray-50 py-12">
      <div className="container mx-auto px-4 mt-10">
        ...
        <div>
        <motion.div
          className="relative h-[600px] flex items-center justify-center mb-16 overflow-hidden rounded-lg shadow-lg"
          initial={{ opacity: 0 }}
        ...
        <motion.div
          ...
          className="flex flex-col lg:flex-row items-center gap-8 p-35"
        >
          <motion.div
          ...
          >
            <img
              src="https://s.oneroof.co.nz/image/c7/cf/c7cf16529f28096babe7762a78abf44b.jpg?x-oss-process=image/quality,q_80/resize,w_750/format,webp"
              alt="About Us"
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8 }}
          className="flex flex-col lg:flex-row-reverse items-center gap-8 p-25 pt-20"
        >
          <motion.div
            className="w-full lg:w-1/2"
            whileHover={{ scale: 1.02 }}
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8 }}
          className="flex flex-col lg:flex-row items-center gap-9 p-50 pt-20"
        >
          <motion.div
            className="w-full lg:w-1/2"
            whileHover={{ scale: 1.02 }}
